<div class="container">
    <div class="dark-bg-gray-900 shadow rounded">
        <div class="row">
            <div class="col-sm-3">
                <div class="p-4">
                    <h5>Mailbox</h5>
                    ...
                    <ul class="list-unstyled mt-4">
                        <li class="p-3 rounded bg-primary"><a class="nav-link"><i class="fa-solid fa-inbox me-3"></i>Inbox</a></li>
                        <li class="p-3 rounded "><a class="nav-link"><i class="fa-solid fa-paper-plane me-3 text-muted"></i>Sent Emails</a></li>
                        <li class="p-3 rounded "><a class="nav-link"><i class="fa-solid fa-star me-3 text-muted"></i>Favourite</a></li>
                        <li class="p-3 rounded "><a class="nav-link"><i class="fa-solid fa-pencil me-3 text-muted"></i>Draft</a></li>
                        <li class="p-3 rounded "><a class="nav-link"><i class="fa-solid fa-trash-can me-3 text-muted"></i>Deleted</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-4">
                    ...
                    <form class="row row-cols-lg-auto g-3 align-items-center mb-3">
                        <div class="col-12 w-100">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-text bg-success"><i class="fa-solid fa-magnifying-glass"></i></div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="col-sm-5">
                <div class="p-2 pt-4">
                    ...
                    <div>
                        <p class="mb-0"><span class="text-muted">From : </span> Dinesh P < curfcode@gmail.com>
                        </p>
                        <p><span class="text-muted">To : </span> Harish V < contact@curfcode.com>
                                </curfcode>
                        </p>
                    </div>

<div class="container-fluid p-5 d-flex d-none position-fixed bottom-0 bg-main-blue border border-main-orange text-white" id="cookie-banner-container">
    <div class="row">
        ...
        <div class="col-12 col-lg-6 mt-3 mt-lg-0 text-center d-flex flex-column flex-lg-row align-items-center justify-content-center gap-3">

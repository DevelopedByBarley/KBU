...
class TeamSport extends Model
{
  ...
  public function store($body)
  {
    ...
    try {
      ...
      $stmt = $this->Pdo->prepare("INSERT INTO `team_sports` (`id`, `name`, `color`, `max`, `main_teamRef_id`, `created_at`) VALUES (NULL, :name, :color, :max, :main_teamRef_id, current_timestamp())");
